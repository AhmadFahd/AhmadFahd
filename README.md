...
*Building resilient products at scale*
...
Lead Software Engineer with a focus on backend architecture, microservices, and full-stack delivery. I design and build systems that prioritize reliability, scalability, and clean engineering — from API design to production deployment.
...
<!-- ✏️ Replace each row with your actual roles -->
...
![Microservices](https://img.shields.io/badge/Microservices-FF6C37?style=flat&logo=apachekafka&logoColor=white)
